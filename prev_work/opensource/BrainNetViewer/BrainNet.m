...
if EC.msh.doublebrain == 1 %% Edited by Mingrui Xia, 20130818, fix the bug that the label only appear in the first brain
    switch EC.lot.view_direction
        case {1,4}
            %         text(surf.sphere(j,1),surf.sphere(j,2),surf.sphere(j,3)+surf.sphere(j,7)*EC.nod.size_ratio+2,surf.label{j}{1}{1},EC.lbl_font,'HorizontalAlignment','center');
            text(0,surf.sphere2(j,2),surf.sphere2(j,3)+surf.sphere2(j,7)*EC.nod.size_ratio+2,surf.label{j}{1}{1},EC.lbl_font,'HorizontalAlignment','center');
        case 2
            if surf.sphere2(j,1)<=0
                text(surf.sphere2(j,1),surf.sphere2(j,2)+surf.sphere2(j,7)*EC.nod.size_ratio+2,surf.sphere2(j,3),surf.label{j}{1}{1},EC.lbl_font,'HorizontalAlignment','right')
            else
                text(surf.sphere2(j,1),surf.sphere2(j,2)+surf.sphere2(j,7)*EC.nod.size_ratio+2,surf.sphere2(j,3),surf.label{j}{1}{1},EC.lbl_font,'HorizontalAlignment','left')
            end
        case 3
            if surf.sphere2(j,1)<=0
                text(surf.sphere2(j,1),surf.sphere2(j,2),surf.sphere2(j,3)+surf.sphere2(j,7)*EC.nod.size_ratio+2,surf.label{j}{1}{1},EC.lbl_font,'HorizontalAlignment','left')
            else
                text(surf.sphere2(j,1),surf.sphere2(j,2),surf.sphere2(j,3)+surf.sphere2(j,7)*EC.nod.size_ratio+2,surf.label{j}{1}{1},EC.lbl_font,'HorizontalAlignment','right')
            end
...
% if surf.label{j}{1}{1}~='-'
if ~isequal(surf.label{j}{1}{1},'-') % Editied by Mingrui Xia, 20131226, fix the bug that the label doesn't displayed when including '-'
    switch EC.lbl
        case 1
            if n==8
                PlotLabel8(surf,i,j);
...
if isfield(FLAG,'IsCalledByREST') && FLAG.IsCalledByREST==1
    ...
    switch EC.vol.color_map
        ...
        case 18 % Added by Mingrui Xia, 20120806, spectral colorbar.
