...
% ------------------------------
% Usage: [ AllSubject ] = S_sbjlist(LoadPath, fgSubordination)
...
function [AllSubject,Head,Common,Ext] = S_sbjlist(LoadPath, fgSubordination)
% ver 0.50 : rename this function
...
%clearvars -except LoadPath fgSubordination
	...
	if nargin < 1,	help ('S_sbjlist'); return; end
