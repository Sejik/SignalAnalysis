...
%% set path
% input
datDir = 'C:\Users\win\Desktop\VR분석\5. econnectome\2. mat';
roiDir = 'C:\Users\win\Desktop\VR분석\5. econnectome\0. ROI';
% output
connectivity = 'C:\Users\win\Desktop\VR분석\5. econnectome\3. result';

%% set parameter (number of timepoints should bigger than 20 * number of ROIs)
% source image time
startEpoch = 2650; % first point = 1;
endEpoch = 3150; % end point = EEG.points;
% ROI time series
ROIfileName = 'ROI_VR_4BA.mat';
...
%% main
for DataNum = 1:9 %length(eeg_info)
    cd(datDir);
