...
%% set variable
% basic parameter (bbci)
bbciDir = '';
MyDataDir = ''; % raw data by eeg
MyTempDir = ''; % temp data directory for bbci

% input
eegOrDat = 1; % 1: using raw data by eeg (bbci processing), 0: using raw data by dat (brain analyzer process)
eegDir = 'C:\Users\win\Desktop\Research\3. Analyze\Data\Test\eeg';
datDir = 'C:\Users\win\Desktop\Research\3. Analyze\Data\Test\dat'; 
roiDir = 'C:\Users\win\Desktop\Research\3. Analyze\Data\TIN\TIN\ROI';
% 나중에 ROI를 자동으로 잡아줄 수 있는 코드를 만들 것. (brainNet 엑셀 얻는 방법 알아내기)
