...
toolhandle = findobj(hButtons,'tag','Plottools.PlottoolsOn'); % Show plot tools
set(toolhandle,'Visible','on');
...
[valmin, valmax] = deal(min(valmin, valmax), max(valmin,valmax));   % 20160524 by tigoum
[valmin, valmax] = deal(max(valmin, 0), min(valmax, 1));   % 20160524 by tigoum
if valmin == valmax, [valmin, valmax]= deal(valmin-1.0e-3, valmax+1.0e-3); end % 20160524 by tigoum
[valmin, valmax] = deal(max(valmin, 0), min(valmax, 1));   % 20160524 by tigoum
