function [new_gamma2] = DTFsigvalues(ts, low_freq, high_freq, p, fs, shufftimes, siglevel)
...
if isempty(shufftimes),	nreps = 1000; else nreps = shufftimes; end
...
for i=1:nreps
	...
	fprintf('DTFsigvalues: %s\r', progress);
