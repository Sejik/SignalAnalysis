...
% Last Modified by GUIDE v2.5 06-Sep-2012 22:41:08
...
set(handles.editFreq, 'String', sprintf('%.10g', val));
...
set(handles.editAmpl, 'String', sprintf('%g', val));
...
% --- Executes on button press in pushbuttonDigMod.
function pushbuttonDigMod_Callback(hObject, eventdata, handles)
% hObject    handle to pushbuttonDigMod (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in pushbuttonBarker.
function pushbuttonBarker_Callback(hObject, eventdata, handles)
% hObject    handle to pushbuttonBarker (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
if (~isempty(cycleTime))
    set(handles.editCycleTime, 'String', sprintf('%g', cycleTime));
end
