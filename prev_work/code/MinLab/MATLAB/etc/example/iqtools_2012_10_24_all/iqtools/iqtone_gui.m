...
% Last Modified by GUIDE v2.5 22-Sep-2012 08:43:49
...
if (isvector(value) && ~isempty(value) && isempty(find(abs(value) > 12e9)))
    numTones = evalin('base', get(handles.editTones, 'String'));
    startFreq = value;
    stopFreq = evalin('base', ['[' get(handles.editStopFreq, 'String') ']']);
    if (numTones <= 1)
...
if (isvector(value) && isempty(find(value < 0)) && isempty(find(value > 8e9)))
    set(hObject,'BackgroundColor','white');
else
    set(hObject,'BackgroundColor','red');
end
...
if (isvector(value) && isempty(find(value < -8e9)) && isempty(find(value > 8e9)))
    set(hObject,'BackgroundColor','white');
else
    set(hObject,'BackgroundColor','red');
end
