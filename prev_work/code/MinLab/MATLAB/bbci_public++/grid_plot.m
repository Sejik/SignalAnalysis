...
%opt_plot={'Legend',1, 'Title','', 'UnitDispPolicy','label','GridOverPatches',0};
% UnitDispPolicy == none | label | lasttick
...
%      if leg_pos(4)>leg_pos_orig(4),
        switch(lower(opt.LegendVerticalAlignment)), 
         ...
         case 'bottom',
           leg_pos(1)= leg_pos(1)-leg_pos_orig(3)/16; %by tigoum, as left as long
           leg_pos(2)= leg_pos(2)-leg_pos(4)*4/5;
        end
%      end
