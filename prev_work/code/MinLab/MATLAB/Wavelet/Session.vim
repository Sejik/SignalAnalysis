...
silent only
cd /home2/minlab/MATLAB/Wavelet
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +37 c_wavelet_EXP_AmH.m
badd +93 A_globals_AmH.m
badd +1 load_ExpInfo_AmH.m
badd +1 d2_Interp_FindChan_Topoplot_AmH.m
badd +17 MakeVHDR_AmH.m
badd +1 AmHlib_FindBad_ChInterp.m
badd +35 AmHlib_ERP_overlap.m
badd +5 ~/ResAnDev/mLib_AmH/mLib_load_VHDR_AmH.m
badd +35 GrandAvg4SKK_AmH.m
badd +1 /home2/minlab/MATLAB/mLib++/mLib_GrAvCombi_AmH.m
args c_wavelet_EXP_AmH.m
edit load_ExpInfo_AmH.m
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 93 - ((15 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
93
...
158
normal! zo
let s:l = 237 - ((12 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
237
...
wincmd w
argglobal
edit /home2/minlab/MATLAB/mLib++/mLib_GrAvCombi_AmH.m
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 56 - ((4 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
wincmd w
argglobal
edit AmHlib_FindBad_ChInterp.m
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
wincmd w
argglobal
edit d2_Interp_FindChan_Topoplot_AmH.m
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal nobinary
...
exe 'vert 1resize ' . ((&columns * 81 + 81) / 163)
exe 'vert 2resize ' . ((&columns * 81 + 81) / 163)
tabedit ~/ResAnDev/mLib_AmH/mLib_load_VHDR_AmH.m
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
