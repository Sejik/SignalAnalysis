...
silent only
cd /home2/minlab/Tools/MATLAB/siamac+fazli++
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 convert_data.m
badd +0 session_list.txt
badd +1 try_classification.m
badd +0 try_classification_CSP.m
args convert_data.m session_list.txt try_classification.m try_classification_CSP.m
edit convert_data.m
...
exe 'vert 1resize ' . ((&columns * 81 + 81) / 163)
exe 'vert 2resize ' . ((&columns * 81 + 81) / 163)
tabedit try_classification_CSP.m
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 68 - ((3 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
