function [ nProc ]	=	investigate_spectral_classification_NewFormat_Norm(	...
							hEEG, condi, epos, verbose)
%% 기본 구성에 대해 추가로 normalization 을 수행한 후,
...
for sj_ix = 1:n_subjects
	...
	% normalize features by baseline correction

	% normalize features by normalization(통계적 정규화)
