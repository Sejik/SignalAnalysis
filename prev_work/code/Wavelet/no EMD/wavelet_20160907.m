...
% directory
file.inputDir = 'C:\Users\win\Desktop\SJ_Toolbox\data\dat'; % input File directory
file.outputDir = 'C:\Users\win\Desktop\SJ_Toolbox\data\wavelet'; % output File directory
...
% param.individualFreq{1} = [0.5 3.5]; % delta
...
param.interestLatency{2} = [0.000 1.500]; % post-stimulus
param.zeroLatency = 0.5;
param.m = 7; param.ki = 5; % wavelet parameter
param.fs = 1000;
param.epochLength = param.fs * 2.0;
